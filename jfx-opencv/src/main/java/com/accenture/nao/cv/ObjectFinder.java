...
import static org.bytedeco.javacpp.opencv_flann.Index;
import static org.bytedeco.javacpp.opencv_flann.IndexParams;
import static org.bytedeco.javacpp.opencv_flann.LshIndexParams;
import static org.bytedeco.javacpp.opencv_flann.SearchParams;
 ...
 * @author Samuel Audet
 *         <p>
 *         ObjectFinder does not work out-of-the-box under Android, because it lacks the standard java.beans.beancontext package. We can work around
 *         it by doing the following *BEFORE* following the instructions in the README.md file:
 *         <p>
 *         1. Remove BaseChildSettings.class and BaseSettings.class from javacv.jar 2. Follow the instructions in the README.md file 3. In your
 *         project, define empty classes BaseChildSettings and BaseSettings under the org.bytedeco.javacv package name
 */
public class ObjectFinder {
	...
	public static void main(String[] args) throws Exception {
		...
		String objectFilename = args.length == 2 ? args[0] : "c://temp//inputs//bookobject.jpg";
		String sceneFilename = args.length == 2 ? args[1] : "c://temp//inputs//bookscene.jpg";
